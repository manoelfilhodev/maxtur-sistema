...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-dark table-striped">
                    <thead><tr><th>Solicitacao</th><th>Minutos</th><th>Motivo</th><th>Data</th></tr></thead>
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="4">Sem atrasos de viagem.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-dark table-striped">
                    <thead><tr><th>Solicitacao</th><th>Passageiro</th><th>Minutos</th><th>Motivo</th><th>Data</th></tr></thead>
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="5">Sem atrasos por passageiro.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
