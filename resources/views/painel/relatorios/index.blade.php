...
<div class="d-flex align-items-start justify-content-between flex-wrap gap-2">
  <div>
    ...
    <div class="text-muted" style="color: rgba(255,255,255,.65) !important;">
      Exportação em Excel e PDF com filtros por período e colaborador
    </div>
  </div>
</div>
@endsection
        ...
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between">
            <div>
              ...
              <div class="text-muted" style="color: rgba(255,255,255,.65) !important;">
                Excel com abas por colaborador + PDF organizado por funcionário
              </div>
            </div>
        ...
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between">
            <div>
              ...
              <div class="text-muted" style="color: rgba(255,255,255,.65) !important;">
                Visão consolidada por dia (entrada/intervalo/retorno/saída)
              </div>
            </div>
            <div class="text-white-50">
          ...
          <div class="mt-3 d-flex flex-wrap gap-2">
            ...
            <span class="badge rounded-pill bg-dark border" style="border-color: rgba(255,255,255,.15) !important;">Total do dia</span>
          </div>
        </div>
      </div>
    </a>
