...
@section('page-heading')
    <div class="d-flex align-items-start justify-content-between flex-wrap gap-2">
        <div>
            <h3 class="fw-bold mb-1 text-white">Novo cliente</h3>
            <div class="text-muted" style="color: rgba(255,255,255,.65) !important;">
                Cadastre um cliente para habilitar contratos, cobranças e acesso.
            </div>
        </div>
    ...
    <div class="dash-card p-3 p-lg-4">
        <div class="d-flex align-items-start justify-content-between flex-wrap gap-2">
            <div>
                ...
                <div class="hint">Preencha os dados principais. Você pode completar o restante depois.</div>
            </div>

            <div class="muted small">
                Campos com <span class="text-white fw-bold">*</span> são obrigatórios
            </div>
        </div>
